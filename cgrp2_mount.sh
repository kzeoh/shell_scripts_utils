...
if echo 500 > $dir/cgroup2/group2/group21/io.bfq.weight;then
	echo "changed group21 weight to 500"
else
	echo "failed changing weight group21"
fi

if echo 600 > $dir/cgroup2/group2/group22/io.bfq.weight;then
	echo "changed group22 weight to 550"
else
	echo "failed changing weight group22"
fi

if echo "+io" > $dir/cgroup2/group2/group22/cgroup.subtree_control; then
	echo "added io controller to group22"
else
	echo "failed adding io controller to group22"
fi

if [ ! -d ${dir}/cgroup2/group2/group22/group221 ]; then
	mkdir $dir/cgroup2/group2/group22/group221 $dir/cgroup2/group2/group22/group222
fi

if echo 200 > $dir/cgroup2/group2/group22/group221/io.bfq.weight;then
	echo "changed group221 weight to 200"
else
	echo "failed changing weight group221"
fi

if echo 800 > $dir/cgroup2/group2/group22/group222/io.bfq.weight;then
...
if echo 300 > $dir/cgroup2/group3/group31/io.bfq.weight;then
...
if echo 400 > $dir/cgroup2/group4/group41/io.bfq.weight;then
...
then
	...
	do
		...
		then
			echo $pid > $dir/cgroup2/group2/group22/group221/cgroup.procs	
		elif [ $i == "4" ]
		then
			echo $pid > $dir/cgroup2/group2/group22/group222/cgroup.procs	
		elif [ $i == "5" ]
		then
