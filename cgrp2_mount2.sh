...
if echo 1000 > $dir/cgroup2/group1/group11/io.bfq.weight;then
	echo "changed group11 weight to 1000"
else
...
if [ ! -d ${dir}/cgroup2/group2/group21 ]; then
	mkdir $dir/cgroup2/group2/group21
fi

if echo 1000 > $dir/cgroup2/group2/group21/io.bfq.weight;then
	echo "changed group21 weight to 1000"
else
