...
#		mount /dev/nvme0n1p1 ${mountdir} -t ext4 -o data=ordered
	...
	if echo 500 > $dir/group3/group31/io.bfq.weight;then
		echo "changed group21 weight to 500"
	else
		echo "failed changing weight group31"
	fi
	
	if echo 500 > $dir/group3/group32/io.bfq.weight;then
		echo "changed group21 weight to 500"
	else
	...
	if echo 200 > $dir/group3/group32/group321/io.bfq.weight;then
		echo "changed group21 weight to 200"
	else
		echo "failed changing weight group321"
	fi
	
	if echo 800 > $dir/group3/group32/group322/io.bfq.weight;then
	...
	if echo 600 > $dir/group4/group42/io.bfq.weight;then
	...
	if echo 200 > $dir/group4/group41/group411/io.bfq.weight;then
		echo "changed group411 weight to 200"
	else
		echo "failed changing weight group211"
	fi
	
	if echo 800 > $dir/group4/group41/group412/io.bfq.weight;then
	...
	if echo 300 > $dir/group4/group42/group421/io.bfq.weight;then
		echo "changed group421 weight to 300"
	else
		echo "failed changing weight group421"
	fi
	
	if echo 700 > $dir/group4/group42/group422/io.bfq.weight;then
