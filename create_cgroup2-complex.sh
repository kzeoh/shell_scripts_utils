...
#		fdisk /dev/nvme0n1
	...
	if echo 900 > $dir/group2/group21/io.bfq.weight;then
		echo "changed group21 weight to 900"
	else
		echo "failed changing weight group21"
	fi
	
	if echo 100 > $dir/group2/group22/io.bfq.weight;then
	...
	if echo 300 > $dir/group2/group21/group211/io.bfq.weight;then
		echo "changed group21 weight to 300"
	else
		echo "failed changing weight group211"
	fi
	
	if echo 700 > $dir/group2/group21/group212/io.bfq.weight;then
	...
	if echo 100 > $dir/group3/group31/io.bfq.weight;then
	...
	if echo 600 > $dir/group3/group31/group311/io.bfq.weight;then
		echo "changed group21 weight to 600"
	else
		echo "failed changing weight group311"
	fi
	
	if echo 400 > $dir/group3/group31/group312/io.bfq.weight;then
	...
	if echo 500 > $dir/group4/group41/io.bfq.weight;then
		echo "changed group41 weight to 500"
	else
		echo "failed changing weight group41"
	fi
	
	if echo 500 > $dir/group4/group42/io.bfq.weight;then
	...
	if echo 200 > $dir/group4/group42/group421/io.bfq.weight;then
		echo "changed group411 weight to 200"
	else
		echo "failed changing weight group211"
	fi
	
	if echo 300 > $dir/group4/group42/group422/io.bfq.weight;then
		echo "changed group412 weight to 300"
	else
		echo "failed changing weight group412"
	fi

	if echo 500 > $dir/group4/group42/group423/io.bfq.weight;then
	...
	if echo 200 > $dir/group4/group42/group423/group4231/io.bfq.weight;then
		echo "changed group4231 weight to 200"
	else
		echo "failed changing weight group211"
	fi
	
	if echo 800 > $dir/group4/group42/group423/group4232/io.bfq.weight;then
